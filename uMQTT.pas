...
const
  MQTT_PROTOCOL = 'MQIsdp'; // 'MQTT'; // 3.1.1
  MQTT_VERSION = 3; // 4; //3.1.1
...
const
  ...
  (
    //    'Reserved',	    //  0	Reserved
    'BROKERCONNECT', //  0	Broker request to connect to Broker    非标准的做法
...
begin
  l := length(aStr);
  AddByte(aStream, l div $100);   // 高位，MSB
  AddByte(aStream, l mod $100);   // 低位，LSB
        ...
        begin
          ...
          begin
            ...
            begin
              ...
              FRxState := rsHdr; // 固定报文头
            end
            else
            begin
              FRxState := rsVarHdr;   // 可变报文头
            end;
          end;
        end;
      rsVarHdr:
